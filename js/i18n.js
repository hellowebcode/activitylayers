...
var UI_DE={
  ...
  'Thirteen data layers.':'Dreizehn Datenebenen.',
  'Ready for the edit.':'Bereit für den Schnitt.',
  'Layer your activity':'Deine Aktivität –',
  'into every frame.':'in jedem Frame sichtbar.',
  'Create thirteen animated overlays for':'Erstelle aus GPX-, FIT- und TCX-Dateien dreizehn animierte Overlays für',
  'and':'und',
  ...
  'Compass overlay style':'Kompass-Overlay-Stil',
  'Scale color':'Farbe der Skala',
  'Tick width':'Strichbreite',
  'Needle color':'Pfeilfarbe',
  'Level color':'Pegelfarbe',
  'Level width':'Pegelbreite',
